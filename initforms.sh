...
INSERT INTO forms ( mytable,group_id,order_id,param,desc,def,cur,new,mandatory,attr,type,link,groupname ) VALUES ( "forms", 1,2,"php_version","php_version: 7.2, 7.3 , ..",'3','3','',1, "maxlen=60", "select", "php_version_select", "" );
...
/usr/local/bin/sqlite3 ${MYPATH}/${HELPER}.sqlite << EOF
BEGIN TRANSACTION;
INSERT INTO php_version_select ( text, order_id ) VALUES ( "7.1", 1 );
INSERT INTO php_version_select ( text, order_id ) VALUES ( "7.2", 2 );
INSERT INTO php_version_select ( text, order_id ) VALUES ( "7.3", 3 );
COMMIT;
EOF
